                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Total Mobil</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['total_cars'] }}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Selamat Datang di Dashboard Admin</h6>
                </div>
                <div class="card-body">
                    <p>Dashboard admin sistem rental mobil. Anda dapat mengelola:</p>
                    <ul>
                        <li>Data mobil</li>
